...
import com.haier.hailicommontlib.mvp.model.volley.AsyncNetwork;
import com.haier.hailicommontlib.mvp.model.volley.AuthFailureError;
import com.haier.hailicommontlib.mvp.model.volley.Header;
...
import com.haier.hailicommontlib.mvp.model.volley.RequestTask;
...
import static com.haier.hailicommontlib.mvp.model.volley.toolbox.NetworkUtility.logSlowRequests;
...
public class BasicAsyncNetwork extends AsyncNetwork {
    ...
    private void onRequestSucceeded(
        ...
        if (responseContents != null) {
            onResponseRead(requestStartMs, statusCode,
                    httpResponse, request, callback,
        ...
        getBlockingExecutor()
                .execute(
                        new ResponseParsingTask<>(
                                inputStream, httpResponse, request,
                                callback, requestStartMs, responseHeaders,
                                statusCode));
    }
    ...
    public void performRequest(final Request<?> request, final OnRequestComplete callback) {
        ...
        getHttpStack().executeRequest(request, additionalRequestHeaders,
                        new AsyncHttpStack.OnRequestComplete() {
                            ...
                            public void onError(IOException ioException) {
                                onRequestFailed(request, callback, ioException, requestStartMs,
                                        /* httpResponse= */ null,
    ...
    private void onResponseRead(
        ...
        if (statusCode < 200 || statusCode > 299) {
            onRequestFailed(request, callback, new IOException(),
                    requestStartMs, httpResponse, responseContents);
            return;
        }
    ...
    private class ResponseParsingTask<T> extends RequestTask<T> {
        ...
        public void run() {
            ...
            onResponseRead(requestStartMs, statusCode,
                    httpResponse, request, callback, responseHeaders,
                    finalResponseContents);
        }
    }
    ...
    public static class Builder {
        ...
        /** Builds the {@link com.haier.hailicommontlib.mvp.model.volley.toolbox.BasicAsyncNetwork} */
