...
import com.haier.hailicommontlib.mvp.model.volley.VolleyLog.MarkerLog;
import com.haier.hailicommontlib.mvp.model.volley.volley_network.BaseNetWorkInterface;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    @Nullable
    @GuardedBy("mLock")
    private BaseNetWorkInterface mErrorListener;
     ...
     */
    @Deprecated
    public Request(String url, BaseNetWorkInterface listener) {
     ...
     */
    public Request(int method, String url, BaseNetWorkInterface listener) {
        mMethod = method;
        mUrl = url;
    ...
    @Nullable
    public BaseNetWorkInterface getErrorListener() {
        synchronized (mLock) {
    ...
    public void deliverError(VolleyError error) {
        BaseNetWorkInterface listener;
        synchronized (mLock) {
            listener = mErrorListener;
        }
        if (listener != null) {
            listener.filed(error);
        }
    }
    ...
    public String toString() {
        ...
        return (isCanceled() ? "[X] " : "[ ] ") + getUrl() + " " + trafficStatsTag
