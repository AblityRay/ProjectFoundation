...
import com.haier.hailicommontlib.mvp.model.volley.Response.ErrorListener;
import com.haier.hailicommontlib.mvp.model.volley.ResponseDelivery;
...
public class ImageLoader {
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, final String cacheKey) {
        return new ImageRequest(requestUrl, new BaseNetWorkInterface<Bitmap>() {
            @Override
            public void success(Bitmap object) {
                onGetImageSuccess(cacheKey, object);
            }

            @Override
            public void filed(Exception e) {
                onGetImageError(cacheKey, (VolleyError)e);
            }

                }, maxWidth, maxHeight, scaleType, Config.RGB_565,
                new BaseNetWorkInterface() {
                    @Override
