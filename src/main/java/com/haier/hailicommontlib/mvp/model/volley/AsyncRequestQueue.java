...
package com.haier.hailicommontlib.mvp.model.volley;

import android.os.Handler;
import android.os.Looper;
import android.os.SystemClock;

import com.haier.hailicommontlib.mvp.model.volley.AsyncCache.OnGetCompleteCallback;
import com.haier.hailicommontlib.mvp.model.volley.AsyncNetwork.OnRequestComplete;
import com.haier.hailicommontlib.mvp.model.volley.Cache.Entry;
import com.haier.hailicommontlib.mvp.model.volley.toolbox.ThrowingCache;
...
public class AsyncRequestQueue extends RequestQueue {
    ...
    private class CacheParseTask<T> extends RequestTask<T> {
        ...
        CacheParseTask(Request<T> request, Entry entry) {
            super(request);
            this.entry = entry;
        }
        ...
        public void run() {
            ...
            Response<?> response = mRequest.parseNetworkResponse(
                    new NetworkResponse(HttpURLConnection.HTTP_OK, entry.data,/* notModified= */ false,
                                    /* networkTimeMs= */ 0, entry.allResponseHeaders));
