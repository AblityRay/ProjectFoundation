...
public class NetworkResponse {
     ...
     */
    @Deprecated
    public NetworkResponse(int statusCode, byte[] data, @Nullable Map<String, String> headers,
     ...
     */
    public NetworkResponse(int statusCode, byte[] data, boolean notModified,
            long networkTimeMs, @Nullable List<Header> allHeaders) {
    ...
    public NetworkResponse(byte[] data) {
        this(
                HttpURLConnection.HTTP_OK, data,/* notModified= */ false,
    ...
    public NetworkResponse(byte[] data, @Nullable Map<String, String> headers) {
        this(
                HttpURLConnection.HTTP_OK, data, headers,
                /* notModified= */ false,/* networkTimeMs= */ 0);
    }

    private NetworkResponse(int statusCode, byte[] data, @Nullable Map<String, String> headers,
            @Nullable List<Header> allHeaders, boolean notModified, long networkTimeMs) {
