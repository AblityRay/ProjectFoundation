...
public class ImageRequest extends Request<Bitmap> {
    ...
    @GuardedBy("mLock")
    @Nullable
    private BaseNetWorkInterface<Bitmap>  mListener;
     ...
     */
    public ImageRequest(String url, BaseNetWorkInterface<Bitmap> listener, int maxWidth, int maxHeight,
            ScaleType scaleType, Config decodeConfig, @Nullable BaseNetWorkInterface errorListener) {
    ...
    @Deprecated
    public ImageRequest(String url, BaseNetWorkInterface<Bitmap> listener, int maxWidth, int maxHeight,
            Config decodeConfig, BaseNetWorkInterface errorListener) {
    ...
    protected void deliverResponse(Bitmap response) {
        BaseNetWorkInterface<Bitmap> listener;
        synchronized (mLock) {
            listener = mListener;
        }
        if (listener != null) {
