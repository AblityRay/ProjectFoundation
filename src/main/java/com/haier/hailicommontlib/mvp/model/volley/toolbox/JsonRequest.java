...
import com.haier.hailicommontlib.mvp.model.volley.Response.Listener;
...
public abstract class JsonRequest<T> extends Request<T> {
     ...
     *
     * @deprecated Use {@link #JsonRequest(int, String, String, Listener, BaseNetWorkInterface)}.
     */
    @Deprecated
    public JsonRequest(
            String url, String requestBody, Listener<T> listener, BaseNetWorkInterface errorListener) {
    ...
    public JsonRequest(
            ...
            Listener<T> listener,
            @Nullable BaseNetWorkInterface errorListener) {
